...
public class MyObject implements Runnable {
    public void run() {
        ...
        Connection mysqlDbConnection = getConnection("mysql");  //class

        executeStatement(mysqlDbConnection, "DROP DATABASE IF EXISTS databaseName;");       //class
        ...
        ResultSet resultSet = executeQuery(mysqlDbConnection, query);   //class
        printResults(resultSet);
    }
    // this class will attempt to register the  jdbc driver
    ...
    // this will try to connect with your chosen database vendor mysql for the win
    ...
    //uses resultset to print the results added into the database
...
// uses scrollable statement to execute the sql statement
